...
For additional plots and analysis, refer to the notebook [2.6-committee-attestations-with-relay-v2.ipynb](../notebooks/2.6-committee-attestations-with-relay-v2.ipynb).
...
<table>
<tr>
<td><img src="../data/model_outputs/26-08-2025_19:35:20/4_relay/LGBMClassifier/shap_beeswarm.png" alt="shap_beeswarm" width="600"/></td>
<td>
...
![late-rate-vs-block-arr](./img/late-rate-vs-block-arr.png)

For additional plots and analysis, refer to the [model_report](../data/model_outputs/26-08-2025_19:35:20/model_report.md). The code to replicate the model training and evaluation is [`late_atts_model_runner.py`](../src/late_atts_model_runner.py).
